...
class AddStudent_new extends StatefulWidget {
  ...
  @override
  _AddStudent_newState createState() => _AddStudent_newState();
}

class _AddStudent_newState extends State<AddStudent_new> {
  ...
  void _addStudent() async {
    ...
    try {
      // Save current auth credentials
      final String facultyUid = _facultyUid;
      ...
      await FirebaseFirestore.instance.collection('users').doc(uid).set({
        ...
        'email': email,
        'role': 'student',
        'fcmToken': _fcmToken ?? 'Unavailable',
        'uuid': uuid,
      ...
      // Sign out the student account from secondary auth
